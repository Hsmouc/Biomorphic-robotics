...
/***********Device base address*************/
#define MPU_DEVICE_ADDRESS		0xD0//MPU6050 Device Address
#define SLAVEADRESS                     0x18
/*Function of MPU6050*/
extern void DelayUs2(unsigned int us);
extern void DelayMs2(unsigned int ms);
extern void IIC2_Init(void);
extern void IIC2_Start(void);
extern void IIC2_Stop(void);
extern void IIC2_Ack(void);
extern void IIC2_SendByte(unsigned char dat);
extern unsigned char IIC2_ReadByte(void);

extern void MPU6050_Init(void);
extern unsigned char MPU6050_ReadByte(unsigned char address);
extern void MPU6050_WriteByte(unsigned char address,unsigned char thedata);
extern void MPU6050_Inital(void);
extern unsigned short MPU6050_GetData(unsigned char REG_Address);
extern unsigned short mpu6050_getdata(unsigned char moudle,unsigned char axis);
extern void HMC_SingleWrite(unsigned char regAddress,unsigned char data);
extern unsigned char HMC_SingleRead(unsigned char regAddress);
